...
from tree_management.demo_generator import generate_demos, generate_mixed_demos
...
def main():
    ...
    parser.add_argument("--distractor_rules",        default="tree_management/distractors/canonical_property_distractor.json")
